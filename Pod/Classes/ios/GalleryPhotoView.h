...
typedef void(^RequestImageCallback)(UIImage *image);
@interface GalleryPhotoView : NSObject<NYTPhoto>
...
@property (nonatomic, copy) RequestImageCallback resultCallback;
@end
